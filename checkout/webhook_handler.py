...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        """ send the user an email when payment completed for their order"""
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if shipping_details.address.state =="":
            shipping_details.address.state = None
        if shipping_details.address.postal_code =="":
            shipping_details.address.postal_code = None
