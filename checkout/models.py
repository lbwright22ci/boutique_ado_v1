...
class Order(models.Model):
    ...
    def __generate_order_number(self):
        """ generates a random order number. Method is private to this model only"""
    ...
    def save(self, *args, **kwargs):
        ...
        if the order does not already have one set"""
...
class OrderLineItem(models.Model):
    ...
    lineitem_total = models.DecimalField(max_digits=6, decimal_places=2, editable=False, null=False, blank=False)
